...
Note: la notarisation est faite via `scripts/notarize.js` (`afterSign`) avec les variables `NOTARIZE_*`, ce qui evite les conflits avec la notarisation interne d'electron-builder.
